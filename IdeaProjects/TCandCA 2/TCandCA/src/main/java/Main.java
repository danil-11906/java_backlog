...
//                0.15*((1/70.9844)*70.9789 - 1) +0.6*((1/0.006662074143595)*0.006663434096883 - 1)));
    ...
    public void initData() {
        ...
        try {
            List<String> pairEUR_RUB = Files.readAllLines(Paths.get("C:/Users/tron5/IdeaProjects/TCandCA 2/TCandCA/CNYRUB.txt"));
            List<String> pairJPY_RUB = Files.readAllLines(Paths.get("C:/Users/tron5/IdeaProjects/TCandCA 2/TCandCA/JPYRUB.txt"));
            List<String> pairUSD_RUB = Files.readAllLines(Paths.get("C:/Users/tron5/IdeaProjects/TCandCA 2/TCandCA/RUBRUB.txt"));
            List<String> pairUZS_RUB = Files.readAllLines(Paths.get("C:/Users/tron5/IdeaProjects/TCandCA 2/TCandCA/USDRUB.txt"));
